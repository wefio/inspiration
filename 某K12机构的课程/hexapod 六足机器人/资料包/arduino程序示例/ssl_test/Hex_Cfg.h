...
#define cSSC_BAUD   115200//38400   //SSC32 BAUD rate
...
//[Botboarduino Pin Numbers]
  ...
  #define PS2_DAT         6//8        
  #define PS2_CMD         7
  #define PS2_SEL         8//6  // On the PS2 receiver this pin may be called ATT (attention)
  #define PS2_CLK         9
...
#define cXXCoxaLength     31//51//45    // This is for CH3-R with Type 3 legs
#define cXXFemurLength    42//75//75
#define cXXTibiaLength    90//137//165
...
#define cRRCoxaInv  0//1
#define cRMCoxaInv  0//1
#define cRFCoxaInv  0//1

#define cRRFemurInv 0//1
#define cRMFemurInv 0//1
#define cRFFemurInv 0//1

#define cRRTibiaInv 0//1
#define cRMTibiaInv 0//1
#define cRFTibiaInv 0//1

#define cLRCoxaInv  0//1
#define cLMCoxaInv  0//1
#define cLFCoxaInv  0//1

#define cLRFemurInv 0//1
#define cLMFemurInv 0//1
#define cLFFemurInv 0//1

#define cLRTibiaInv 0//1
#define cLMTibiaInv 0//1
#define cLFTibiaInv 0//1

//--------------------------------------------------------------------
//[BODY DIMENSIONS]
#define cRRCoxaAngle1   -500//-600   //Default Coxa setup angle, decimals = 1
#define cRMCoxaAngle1    0//0      //Default Coxa setup angle, decimals = 1
#define cRFCoxaAngle1    400//600      //Default Coxa setup angle, decimals = 1
#define cLRCoxaAngle1    -400//-600   //Default Coxa setup angle, decimals = 1
#define cLMCoxaAngle1    0      //Default Coxa setup angle, decimals = 1
#define cLFCoxaAngle1    500//600      //Default Coxa setup angle, decimals = 1

#define cRROffsetX      -42//-68     //Distance X from center of the body to the Right Rear coxa
#define cRROffsetZ      70//118     //Distance Z from center of the body to the Right Rear coxa
#define cRMOffsetX      -56//-91    //Distance X from center of the body to the Right Middle coxa
#define cRMOffsetZ      0       //Distance Z from center of the body to the Right Middle coxa
#define cRFOffsetX      -42//-68     //Distance X from center of the body to the Right Front coxa
#define cRFOffsetZ      -70//-118    //Distance Z from center of the body to the Right Front coxa

#define cLROffsetX      42//69      //Distance X from center of the body to the Left Rear coxa
#define cLROffsetZ      70//118     //Distance Z from center of the body to the Left Rear coxa
#define cLMOffsetX      56//91     //Distance X from center of the body to the Left Middle coxa
#define cLMOffsetZ      0       //Distance Z from center of the body to the Left Middle coxa
#define cLFOffsetX      42//68      //Distance X from center of the body to the Left Front coxa
#define cLFOffsetZ      -70//-118    //Distance Z from center of the body to the Left Front coxa

//--------------------------------------------------------------------
//[START POSITIONS FEET - 起始位置]
#define cHexInitXZ       105//147//147//80//105
#define CHexInitXZCos60  74//104//40//53     // COS(45) = .707  cos(60) = 0.5
#define CHexInitXZSin60  74//104//69//91     // sin(45) = .707  sin(60) = 0.866
#define CHexInitY        25//40//25
